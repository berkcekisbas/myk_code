                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('komisyon/yeni')?>"> <button id="sample_editable_1_new" class="btn sbold green"> Yeni Ekle
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tr class="odd gradeX">
                                            <td> <?php echo $komisyon->id;?> </td>

                                            <td> <?php echo $komisyon->adsoyad;?> </td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-left" role="menu">
                                                        <li>
                                                            <a href="<?php echo base_url('meslek/duzenle/'.$komisyon->id)?>">
                                                                <i class="fa fa-pencil"></i> Düzenle </a>
                                                        </li>

                                                        <li>
                                                            <a onclick='return confirm("Kayıdı Silmek İstediğinizden Emin Misiniz ?")' href="<?php echo base_url('meslek/sil/'.$komisyon->id)?>">
